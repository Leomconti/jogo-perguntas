...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'absolute left-0 right-0 top-[65px] -z-[1] hidden min-h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-md dark:block',
        className
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 items-center justify-center">
        ...
        <motion.div
          ...
          className="bg-gradient-conic absolute inset-auto left-1/2 h-56 w-[50rem] from-transparent via-transparent to-primary text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[52rem] -translate-y-[7rem] bg-neutral-400"
        ></motion.div>
